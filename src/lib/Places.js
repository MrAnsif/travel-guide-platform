    ...
    try {
        const newPlace = await prisma.place.create({
            data: {
                ...
                description: placeData.description, // Now required
                ...
                population: placeData.population || null,
                timezone: placeData.timezone || null,
                languages: placeData.languages || [],
                currency: placeData.currency || null,
                overviewImage: placeData.overviewImage || null,
                overviewThumbnail: placeData.overviewThumbnail || null,
                attractions: placeData.attractions || [], // Now array
                transportationMethods: placeData.transportation?.mainMethods || [], // Now array
                emergencyNumber: placeData.emergencyNumber || null,
                aiGenerated: true,
                ...
                aiContent: {
                    create: {
                        ...
                        bestTimeToVisit: placeData.overview?.bestTimeToVisit || null,
                        averageStayDuration: placeData.overview?.averageStayDuration || null, // Now matches schema
                        ...
                        diningEtiquette: placeData.culture?.etiquette?.dining || null,
